<?php  include "includes/header.php"; ?>
    ...
    <div class="edit-article-page">
        <div class="edit-form">
         ...
         <h3>Edit Or Delete your Articles</h3> 
...
<div class="comment">
<a href="./update-article.php"><button type="submit" id="btn-edit"> <img src="../assets/fonts/edit-solid.svg"/></button></a> 
<button type="submit" class="btn-delete" id="btn-delete"><img src="../assets/fonts/trash-alt-solid.svg"/></button> 
</div>
